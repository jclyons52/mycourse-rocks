					...
					@endif
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p>
                                    <a class="btn btn-primary social-login-btn social-linkedin" href="/login/linkedin"><i class="fa fa-linkedin"></i></a>
                                    <a class="btn btn-primary social-login-btn social-google" href="/login/google"><i class="fa fa-google-plus"></i></a>
                                </p>
                            </div>
                        </div>
